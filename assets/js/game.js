var gameObject = {
	...
	bandsArray: ["FRODO", "GANDALF", "SARUMAN", "ISILDUR", "GOLLUM", "BILBO", "ARAGORN", "LEGOLAS", "GIMLI", "SAMWISE", "SAURON", "ELROND", "GALADRIEL", "BOROMIR"],
	randomWord: "",
	bandLetters:[],
	...
	generateWord: function(){
		//Generate a random number from 0-14
		var random_num = Math.random() * 15;
